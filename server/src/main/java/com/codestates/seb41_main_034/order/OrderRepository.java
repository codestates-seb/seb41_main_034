...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Override
    @Query("select o from Order o where o.id = ?1 and o.isDeleted = false")
    ...
    @Query("select distinct o from Order o left join fetch o.orderProducts where o.id in ?1 and o.isDeleted = false")
