...
class OrderServiceTest {
    ...
    void testCreateOrder() {
        ...
        for (int i = 0; i < postDto.getProducts().size(); i++) {
            assertEquals(postDto.getProducts().get(i).getProductId(), responseDto.getProducts().get(i).getProductId());
            assertEquals(postDto.getProducts().get(i).getQuantity(), responseDto.getProducts().get(i).getQuantity());
        }
    }
